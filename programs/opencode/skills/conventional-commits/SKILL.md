...
description: Guidance for writing Git commits following the Conventional Commits specification (v1.0.0).
license: MIT
compatibility: opencode
metadata:
  source: https://smithery.ai/skills/dgalarza/conventional-commits
---
